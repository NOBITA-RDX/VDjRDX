...
TAGMES = [ " **➠ ʜᴇʏ ʙᴀʙʏ ᴋᴀʜᴀ ʜᴏ 🤗** ",
           ...
           " **➠ ʙᴀʙʏ ʏᴀʜᴀᴀ ᴀᴀᴏ https://t.me/+RObRa7kXPIJmMjU1 ᴅᴏɴᴏ sᴀᴛʜ ᴍᴇ ᴍᴊᴇ ᴋʀᴇɴɢᴇ ᴀᴀᴀᴏ ɴᴀ 🥰** ",
           " **➠ʙᴀʙʏ ʀᴅx ᴛᴜᴍʜᴇ ᴠᴄ ʙᴜʟʟᴀ ʀʜᴀ ʜᴀɪ @ll_Rj29RDX_ll 🥀❤️‍🔥** ",
           " **➠ʙᴀʙʏ sᴛᴜᴅʏ ᴋʀᴇɴɢᴇ ᴀᴀᴏ https://t.me/+PtOLQT04ocMzOTJl 📚** ",
           " **➠ ᴠᴄ ᴘʀ ʏᴇ ᴅᴏɴᴏ  ᴋʏᴀ ᴋʀ ʀʜᴇ ʜᴀɪ ᴊʀᴀ ᴅᴇᴋᴏ 👀** ",
...
VC_TAG = [ "**➠ ᴏʏᴇ ᴠᴄ ᴀᴀᴏ ɴᴀ ᴘʟs 😒**",
         ...
         " **➠ʙᴀʙʏ ʀᴅx ᴛᴜᴍʜᴇ ᴠᴄ ʙᴜʟʟᴀ ʀʜᴀ ʜᴀɪ @ll_Rj29RDX_ll 🥀❤️‍🔥** ",
         " **➠ʙᴀʙʏ sᴛᴜᴅʏ ᴋʀᴇɴɢᴇ ᴀᴀᴏ https://t.me/+PtOLQT04ocMzOTJl 📚** ",
         " **➠ ᴠᴄ ᴘʀ ʏᴇ ᴅᴏɴᴏ @ll_rj29rdx_ll 😘 @Itzrishuxd ᴋʏᴀ ᴋʀ ʀʜᴇ ʜᴀɪ ᴊʀᴀ ᴅᴇᴋᴏ 👀** ",
